...
const SYSTEM_FIELDS: Record<ImportType, SystemField[]> = {
  contas_pagar: [
    ...
    { name: "observacoes", label: "Observações", required: false, type: "text", keywords: ["obs", "nota", "coment", "remark", "detalhe"] },
  ],
  contas_receber: [
    ...
    { name: "observacoes", label: "Observações", required: false, type: "text", keywords: ["obs", "nota", "coment", "detalhe"] },
  ],
  aportes: [
