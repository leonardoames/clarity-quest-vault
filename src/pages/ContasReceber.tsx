...
export default function ContasReceber() {
  ...
  const { data: contas, loading, insert, update, remove } = useEmpresaData<any>("contas_receber", {
          ...
          <div className="space-y-5 max-h-[75vh] overflow-y-auto pr-2">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <Input value={campo(form,"descricao")} onChange={(e) => sf("descricao", e.target.value)} className="bg-secondary border-border text-lg" placeholder="Ex: Venda de produto / Prestação de serviço" />
              </div>
            ...
            <div className="border-t pt-4 mt-4">
              <p className="text-[10px] font-medium uppercase tracking-widest text-muted-foreground mb-3">Recebimento</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
